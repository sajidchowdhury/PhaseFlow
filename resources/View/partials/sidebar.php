<div class="sidebar d-flex flex-column" id="sidebar">
    <div class="sidebar-brand d-flex align-items-center">
        <div>
            <span class="logo">Phase<span class="text-white">Flow</span></span>
            <div style="font-size: 0.75rem; opacity: 0.7; margin-top: -4px;">CRM • Delivery • Growth</div>
        </div>
    </div>
    ...
    <div class="p-3 border-top border-white border-opacity-10 mt-auto">
        <div class="small px-3 py-2 bg-white bg-opacity-10 rounded-3">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <div class="fw-medium text-white">Team Plan</div>
                    <div style="font-size:0.75rem; opacity:0.75;">12 / 25 seats used</div>
                </div>
                <i class="bi bi-people-fill fs-4 text-white text-opacity-50"></i>
            </div>
        </div>
    </div>
</div>